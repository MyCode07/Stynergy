<div class="popup _fixed" id="zamer-montaj">
    <div class="popup__container _container">
        ...
        <div class="form form-white">
            <form action="#">
                ...
                <div class="form__row">
                    <div class="form__item" data-required>
                        <input type="text" name="phone" class="_mask-phone" placeholder="Телефон" inputmode="text">
                    </div>
                </div>
                <div class="form__row">
                    <div class="form__item" data-required>
                        <input type="text" name="address" placeholder="Населенный пункт, шоссе, расстояние от МКАД">
                    </div>
                </div>
                <div class="form__row">
                    <div class="form__item" data-required>
                        <input type="text" name="ploshad" placeholder="Площадь кровли / фасада">
                    </div>
                </div>
                <div class="form__row">
                    <div class="form__item" data-required>
                        <input type="text" name="dop-info" placeholder="Дополнительная информация">
                    </div>
                </div>
